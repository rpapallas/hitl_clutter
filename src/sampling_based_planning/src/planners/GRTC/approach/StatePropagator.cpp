...
#ifndef APPROACHSTATEPROPAGATOR
#define APPROACHSTATEPROPAGATOR

class StatePropagator2 : public StatePropagatorBase {
public:
    StatePropagator2(const oc::SpaceInformationPtr &si, MujocoHelper *mujocoHelper,
