...
#ifndef PUSHSTATEVALIDITY
#define PUSHSTATEVALIDITY

#include "../../../StateValidityCheckerBase.cpp"

class StateValidityChecker3 : public StateValidityCheckerBase {
public:
    StateValidityChecker3(const ob::SpaceInformationPtr &si,
